...
(define no-code-let-env-parser
  (lambda (list-of-2-lists)
    (map (lambda (two-list) (list (car two-list) (no-parser (cadr two-list)))) list-of-2-lists)))
...
;(pop-to-global env)
(define sample-no-code '(local-vars ((a 2) (b 3)) (local-vars ((c 4) (d c) (a (do-mathy-stuff * d 3))) (do-mathy-stuff + b a))))
;sample-no-code
